...
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| http://filmy-19.herokuapp.com/api/v1/auth/signin                                                                                                                                                                                                   |  POST  | Get authentication token                                                                                                                                                                                                                                       |
| http://filmy-19.herokuapp.com/api/v1/status                                                                                                                                                                                                    |  GET   | Get APIs status                                                                                                                                                                                                                                                |
| http://filmy-19.herokuapp.com/api/v1/film <ol>Query options:<li>limit=_integer_</li><li>offset=_integer_</li><li>title=_string_</li><li>title=_string_</li><li>release_year=_integer_</li><li>rating=_integer_</li></ol>                           |  GET   | Get all films <ol>Description of query options:<li>limit the amount of results</li><li>do the query on items with ID greater than the given offset</li><li>by title</li><li>by release year</li><li>>= inserted rating</li></ol>                               |
| http://filmy-19.herokuapp.com/api/v1/film                                                                                                                                                                                                          |  POST  | Add a new film                                                                                                                                                                                                                                                 |
| http://filmy-19.herokuapp.com/api/v1/film/{filmID}                                                                                                                                                                                                 |  GET   | Get film by ID                                                                                                                                                                                                                                                 |
| http://filmy-19.herokuapp.com/api/v1/film/{filmID}                                                                                                                                                                                                 |  PUT   | Update film by ID                                                                                                                                                                                                                                              |
| http://filmy-19.herokuapp.com/api/v1/film/{filmID}                                                                                                                                                                                                 | DELETE | Delete film by ID                                                                                                                                                                                                                                              |
| http://filmy-19.herokuapp.com/api/v1/actor <ol>Query options:<li>limit=_integer_</li><li>offset=_integer_</li><li>name=_string_</li><li>surname=_string_</li><li>birth_year=_integer_</li><li>death_year=_integer_</li><li>gender=_char_</li></ol> |  GET   | Get all actors <ol>Description of query options:<li>limit the amount of results</li><li>do the query on items with ID greater than the given offset</li><li>by name</li><li>by surname</li><li>by birth year</li><li>by death year</li><li>by gender</li></ol> |
| http://filmy-19.herokuapp.com/api/v1/actor                                                                                                                                                                                                         |  POST  | Add new actor                                                                                                                                                                                                                                                  |
| http://filmy-19.herokuapp.com/api/v1/actor/{actorID}                                                                                                                                                                                               |  GET   | Get actor by ID                                                                                                                                                                                                                                                |
| http://filmy-19.herokuapp.com/api/v1/actor/{actorID}                                                                                                                                                                                               |  PUT   | Update actor by ID                                                                                                                                                                                                                                             |
| http://filmy-19.herokuapp.com/api/v1/actor/{actorID}                                                                                                                                                                                               | DELETE | Delete actor by ID                                                                                                                                                                                                                                             |
| http://filmy-19.herokuapp.com/api/v1/user <ol>Query options:<li>limit=_integer_</li><li>offset=_integer_</li></ol>                                                                                                                                 |  GET   | Get all users <ol>Description of query options:<li>limit the amount of results</li><li>do the query on items with ID greater than the given offset</li></ol>                                                                                                   |
| http://filmy-19.herokuapp.com/api/v1/user                                                                                                                                                                                                          |  POST  | Add new user                                                                                                                                                                                                                                                   |
| http://filmy-19.herokuapp.com/api/v1/user/{userID}                                                                                                                                                                                                 |  GET   | Get user by ID                                                                                                                                                                                                                                                 |
| http://filmy-19.herokuapp.com/api/v1/user/{userID}                                                                                                                                                                                                 |  PUT   | Update user by ID                                                                                                                                                                                                                                              |
| http://filmy-19.herokuapp.com/api/v1/user/{userID}                                                                                                                                                                                                 | DELETE | Delete user by ID                                                                                                                                                                                                                                              |
