...
| http://filmy-19.herokuapp.com/v1/film <ol>Query options:<li>limit=_integer_</li><li>offset=_integer_</li><li>title=_string_</li><li>title=_string_</li><li>release*year=\_integer*</li><li>rating=_integer_</li></ol>                            |  GET   | Get all films <ol>Description of query options:<li>limit the amount of results</li><li>do the query on items with ID greater than the given offset</li><li>by title</li><li>by release year</li><li>>= inserted rating</li></ol>                               |
...
| http://filmy-19.herokuapp.com/v1/actor <ol>Query options:<li>limit=_integer_</li><li>offset=_integer_</li><li>name=_string_</li><li>surname=_string_</li><li>birth*year=\_integer*</li><li>death*year=\_integer*</li><li>gender=_char_</li></ol> |  GET   | Get all actors <ol>Description of query options:<li>limit the amount of results</li><li>do the query on items with ID greater than the given offset</li><li>by name</li><li>by surname</li><li>by birth year</li><li>by death year</li><li>by gender</li></ol> |
