...
| http://filmy-19.herokuapp.com/v1/film <ol>Query options:<li>title=_string_</li><li>release_year=_integer_</li><li>rating=_integer_</li></ol>                                                  |  GET   | Get all films <ol>Description of query options:<li>by title</li><li>by release year</li><li>>= inserted rating</li></ol>                               |
...
| http://filmy-19.herokuapp.com/api/v1/actor <ol>Query options:<li>name=_string_</li><li>surname=_string_</li><li>birth_year=_integer_</li><li>death_year=_integer_</li><li>gender=_char_</li></ol> |  GET   | Get all actors <ol>Description of query options:<li>by name</li><li>by surname</li><li>by birth year</li><li>by death year</li><li>by gender</li></ol> |
...
| http://filmy-19.herokuapp.com/api/v1/user                                                                                                                                                         |  GET   | Get all users                                                                                                                                          |
